...
struct PrintFOpt : public LibCallOptimization {
  Value *OptimizeFixedFormatString(Function *Callee, CallInst *CI,
    ...
    StringRef FormatStr;
#if defined(AMD_OPENCL) || 1
    CallSite CS(cast<Value>(CI));
    StringRef str(CS.getCaller()->getName());
    // turn off printf to puts optimization within OpenCL kernels
    // printf will be converted to sequence of stores and syscall
