...
const char *llvm::dwarf::TagString(unsigned Tag) {
  ...
  case DW_TAG_HSA_argument_scope:        return "DW_TAG_HSA_argument_scope";
#endif
...
const char *llvm::dwarf::AttributeString(unsigned Attribute) {
  ...
  case DW_AT_AMDIL_address_space:        return "DW_AT_AMDIL_address_space";
  case DW_AT_AMDIL_resource:             return "DW_AT_AMDIL_resource";
#if defined(AMD_OPENCL) || 1
  case DW_AT_HSA_is_kernel:              return "DW_AT_HSA_is_kernel";
  case DW_AT_HSA_is_outParam:            return "DW_AT_HSA_is_outParam";
  case DW_AT_HSA_workitemid_offset:      return "DW_AT_HSA_workitemid_offset";
  case DW_AT_HSA_isa_memory_region:      return "DW_AT_HSA_isa_memory_region";
  case DW_AT_HSA_brig_offset:            return "DW_AT_HSA_brig_offset";
#endif
  }
  return 0;
}
...
#if defined(AMD_OPENCL) || 1
  case DW_LANG_HSA_Assembly:             return "DW_LANG_HSA_Assembly";
#endif
  }
  return 0;
}
