...
void *LLVMContext::getAMDLLVMContextHook() {
  return pImpl->AMDHook;
}

void LLVMContext::setAMDLLVMContextHook(void *AMDHook) {
  pImpl->AMDHook = static_cast<AMDLLVMContextHook*>(AMDHook);
}
#endif
