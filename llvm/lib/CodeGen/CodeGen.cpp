...
void llvm::initializeCodeGen(PassRegistry &Registry) {
  ...
  initializeAMDILCFGPreparePass(Registry);
  initializeAMDILCFGPerformPass(Registry);
#endif // WITH_TARGET_AMDIL

#if defined(WITH_TARGET_HSAIL)
  initializeHSAILControlDependencyAnalysisPass(Registry);
  initializeHSAILUniformOperationsPass(Registry);
  initializeHSAILOptimizeMemoryOpsPass(Registry);
  initializeHSAILResizeLocalPointerPass(Registry);
  initializeHSAILDAGToDAGISelPass(Registry);
  initializeHSAILPropagateImageOperandsPass(Registry);
