...
MachineInstr::MachineInstr(MachineFunction &MF, const MachineInstr &MI)
  ...
  // Copy all the AsmPrinterFlags, this won't ever be in
  // the TOT as LLVM does not believe that AsmPrinterFlags
  // should have useful information in it.
...
#if 1
      // FIXME: Remove this (OpenCL bug 9043)
      ||
