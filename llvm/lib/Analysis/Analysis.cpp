...
void llvm::initializeAnalysis(PassRegistry &Registry) {
  ...
  initializeLivenessAnalysisPass(Registry);
  initializeAMDAlignmentAnalysisPass(Registry);
  initializeAMDExportKernelNaturePass(Registry);
  initializeAMDFenceInfoAnalysisPass(Registry);
  initializeAMDAliasAnalysisPass(Registry);
#endif
}
