...
; CHECK-LABEL: @test_copy_v4i8_volatile_load
...
; CHECK-LABEL: @test_copy_v4i8_volatile_store
; CHECK: uav_raw_load_id
; CHECK: uav_byte_store_id
; CHECK: uav_byte_store_id
; CHECK: uav_byte_store_id
; CHECK: uav_byte_store_id
; CHECK: ret_dyn
...
; CHECK-LABEL: @test_copy_v4i8_volatile_load_store
; CHECK: uav_ubyte_load_id
; CHECK: uav_ubyte_load_id
; CHECK: uav_ubyte_load_id
; CHECK: uav_ubyte_load_id
...
; CHECK: uav_byte_store_id
; CHECK: ret_dyn
define void @test_copy_v4i8_volatile_load_store(<4 x i8> addrspace(1)* %out, <4 x i8> addrspace(1)* %in) nounwind {
  %val = load volatile <4 x i8> addrspace(1)* %in, align 4
  store volatile <4 x i8> %val, <4 x i8> addrspace(1)* %out, align 4
  ret void
}
