...
; Test that loads from constant buffers of both globally scoped and kernel
; arguments are marked cached.
...
; CHECK: uav_raw_load_id(10)_cached
; CHECK: uav_raw_load_id(10)_cached
; CHECK: uav_raw_load_id(10)_cached
...
@llvm.signedOrSignedpointee.annotations.__OpenCL_constant_kernel_kernel = global [2 x i8*] [i8* bitcast ([4 x i8] addrspace(2)* @.str to i8*), i8* bitcast ([3 x i8] addrspace(2)* @.str2 to i8*)], section "llvm.metadata"
@llvm.argtypename.annotations.__OpenCL_constant_kernel_kernel = global [2 x i8*] [i8* bitcast ([5 x i8] addrspace(2)* @.str1 to i8*), i8* bitcast ([5 x i8] addrspace(2)* @.str3 to i8*)], section "llvm.metadata"
@sgv = internal addrspace(2) constant [1 x i8] zeroinitializer
@fgv = internal addrspace(2) constant [1 x i8] zeroinitializer
@lvgv = internal constant [0 x i8*] zeroinitializer
@rvgv = internal constant [0 x i8*] zeroinitializer
@llvm.global.annotations = appending global [1 x { i8*, i8*, i8*, i8*, i8*, i32 }] [{ i8*, i8*, i8*, i8*, i8*, i32 } { i8* bitcast (void (i32 addrspace(1)*, i32 addrspace(2)*)* @__OpenCL_constant_kernel_kernel to i8*), i8* bitcast ([1 x i8] addrspace(2)* @sgv to i8*), i8* bitcast ([1 x i8] addrspace(2)* @fgv to i8*), i8* bitcast ([0 x i8*]* @lvgv to i8*), i8* bitcast ([0 x i8*]* @rvgv to i8*), i32 0 }], section "llvm.metadata"

define  void @__OpenCL_constant_kernel_kernel(i32 addrspace(1)* nocapture %out, i32 addrspace(2)* nocapture %in) nounwind {
entry:
  ...
  %tmp14 = add nsw i32 %1, 2
  %arrayidx15 = getelementptr i32 addrspace(1)* %out, i32 %tmp14
  %arrayidx18 = getelementptr i32 addrspace(2)* %in, i32 %1
  %tmp19 = load i32 addrspace(2)* %arrayidx18, align 4
  store i32 %tmp19, i32 addrspace(1)* %arrayidx15, align 4
  ret void
}
