...
; CHECK-LABEL: @no_reorder_v2f64_global_load_store
...
; CHECK-LABEL: @no_reorder_scalarized_v2f64_local_load_store
; CHECK: lds_load_vec_id
; CHECK: lds_load_vec_id
; CHECK: lds_store_vec_id
; CHECK: lds_store_vec_id
; CHECK: ret_dyn
...
; CHECK-LABEL: @no_reorder_split_v8i32_global_load_store
; CHECK: uav_raw_load_id
; CHECK: uav_raw_load_id
; CHECK: uav_raw_load_id
; CHECK: uav_raw_load_id
...
; CHECK-LABEL: @no_reorder_extload_64
; CHECK: lds_load_id
; CHECK: lds_load_id
; CHECK: lds_load_id
; CHECK: lds_load_id
