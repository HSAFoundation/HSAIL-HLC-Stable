...
public:
  ...
  // jgolds
  // This was removed since it was "expensive".  Revisit later if we think it's a bottleneck
  // No argument flip.
...
#if 1 || defined(AMD_OPENCL)
  // jgolds
  // These were removed since they were "expensive".  Revisit later if we think it's a bottleneck
  // No argument flip.
