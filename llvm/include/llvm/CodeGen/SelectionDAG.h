...
public:
...
#if defined(AMD_OPENCL) || 1
                    // Default argument 0 is required for calls
                    // to getAtomic from Target/X86
  ...
  void AssignOrderingRecurs(const SDNode *SD, unsigned Order);
#endif
  ...
  std::pair<SDValue, SDValue> SplitVector(const SDValue &N, const DebugLoc &DL,
