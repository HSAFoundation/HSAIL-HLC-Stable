...
namespace llvm {
  ...
  //===--------------------------------------------------------------------===//
  //
  // createVectorElementAliasAnalysisPass - This pass implements a simple
  // alias analysis using knowledge on vector elements.
  //
  FunctionPass *createVectorElementAliasAnalysisPass();
  //===--------------------------------------------------------------------===//
  //
  // createAMDAlignmentAnalysisPass - This pass implements a simple
  // alignment analysis using knowledge about opencl kernel argument alignments
  //
  FunctionPass *createAMDAlignmentAnalysisPass(unsigned kernelArgAlign);
  FunctionPass *createAMDAlignmentAnalysisPass();
#endif
  ...
  // Print out liveness information, including register usage estimate.
