...
namespace llvm {
  ...
  void ComputeMaskedBits(Value *V,  APInt &KnownZero, APInt &KnownOne,
                         const DataLayout *DL = 0, unsigned Depth = 0);
  ...
  bool isPowerOfTwo(Value *V, const DataLayout *DL = 0, bool OrZero = false,
                    unsigned Depth = 0);
  ...
  /// vectors of integers.
  bool isKnownNonZero(Value *V, const DataLayout *DL = 0, unsigned Depth = 0);
  ...
  ///
  unsigned ComputeNumSignBits(Value *Op, const DataLayout *DL = 0,
                              unsigned Depth = 0);
  ...
  Value *GetUnderlyingObject(Value *V, const DataLayout *DL = 0,
                             unsigned MaxLookup = 6);
  static inline const Value *
  GetUnderlyingObject(const Value *V, const DataLayout *DL = 0,
                      unsigned MaxLookup = 6) {
