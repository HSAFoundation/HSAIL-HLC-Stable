...
#define AMD_HSA
#if defined(AMD_HSA)
/* TODO add additional #define for HSAIL */
#define Get_REL64_isa(dbg)         (R_HSA_DWARF_64)
#define Get_REL32_isa(dbg)         (R_HSA_DWARF_32)
#define Get_REL_SEGREL_isa(dbg)    (R_HSA_DWARF_32)
#else
...
#define Get_REL32_isa(dbg) (1)   /* these are used on __linux__ */
