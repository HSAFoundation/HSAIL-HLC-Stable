...
#if 0
#if 1
#define DW_STRUCT_UNDERBAR_ELF_IN_USE
#ifdef DW_STRUCT_UNDERBAR_ELF_IN_USE
/* Assume http://sourceforge.net/apps/trac/elftoolchain/browser/trunk/libelf/libelf.h
    or the like struct _Elf definition. */
struct _Elf;
typedef struct _Elf * dwarf_elf_handle;
#else /* Assume the traditional struct defined */
struct Elf;
...
#include "libelf.h"
//typedef struct Elf* dwarf_elf_handle;
typedef Elf * dwarf_elf_handle;
// KMW
#endif // #if 1
#else
#define STRUCT_ELF struct _Elf
#ifndef STRUCT_ELF
#define STRUCT_ELF struct Elf
#endif

STRUCT_ELF;
typedef STRUCT_ELF * dwarf_elf_handle;
#endif
