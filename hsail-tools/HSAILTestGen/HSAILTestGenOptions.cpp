...
cl::opt<int>
    rndTestNum("random", 
            cl::desc("Number of additional random values generated for each operand (0 by default). If positive, also used as a seed for randomization; otherwise seed is derived from time()."), 
